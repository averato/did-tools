...
describe('IonRequest', () => {
    ...
    describe('validateDidSuffix', () => {
        it('should throw if id is incorrect encoding', () => {
            try {
                DidRequest.validateDidSuffix('123456789012345678901234567890123456789012345/');
                fail();
            }
            catch (e) {
        ...
        it('should throw if id is not multihash', () => {
            try {
                DidRequest.validateDidSuffix('aaaaaaaa'); // base64 but not multihash
                fail();
            }
            catch (e) {
                if (e instanceof IonError) {
        ...
        it('should throw if id is hashed with unsupported hash code', () => {
            try {
                DidRequest.validateDidSuffix('ERSIwvEfss45KstbKYbmQCEcRpAHPg'); // this is sha1 (code 17), which is not the correct hashing algorithm (code 18)
                fail();
            }
            catch (e) {
