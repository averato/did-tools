...
describe('Multihash', () => __awaiter(void 0, void 0, void 0, function* () {
    describe('hashAsNonMultihashBytes()', () => __awaiter(void 0, void 0, void 0, function* () {
        it('should throw error if hash algorithm given is unsupported.', () => __awaiter(void 0, void 0, void 0, function* () {
            JasmineIonErrorValidator_1.default.expectIonErrorToBeThrownAsync(() => __awaiter(void 0, void 0, void 0, function* () { return Multihash_1.default.hashAsNonMultihashBytes(new TextEncoder().encode('anyThing'), 999); }), ErrorCode_1.default.MultihashUnsupportedHashAlgorithm);
        }));
    }));
}));
